...
const dlNumberPath = '/onboarding/dl-number';
const verifyDetailsPath = '/onboarding/verify-details';
...
String _target(OnboardingStage s) {
  switch (s) {
    ...
    case OnboardingStage.dlNumber:
      return dlNumberPath;
    case OnboardingStage.verifyDetails:
      return verifyDetailsPath;
...
GoRouter buildRouter({
  ...
  required Widget Function() dlNumber,
  required Widget Function() verifyDetails,
